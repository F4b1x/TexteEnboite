...
TexteEnrichis::TexteEnrichis(): nbLigne(0), TabStr(0), OldColor(0) {}
TexteEnrichis::TexteEnrichis(const char* arg, size_t n): nbLigne(0), TabStr(0), OldColor(0)
{
    std::string ligne="";
    std::string phrase="";
...
TexteEnrichis::TexteEnrichis(const std::string arg, size_t n): nbLigne(0), TabStr(0)
{
    std::string ligne="";
